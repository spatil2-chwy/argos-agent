...
def test_response_done_logs_cache_usage_details():
    ...
    assert usage_event["estimated_cost_usd"] == 0.0007168
    assert usage_event["estimated_cached_savings_usd"] == 0.0001564
    assert usage_event["session_total_cost_usd"] == 0.0007168
